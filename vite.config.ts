...
const headers = [
  `<title>Pisitpong Chongpipattanakul - Resume</title>`,
  `<meta name="title" content="Pisitpong Chongpipattanakul - Resume" />`,
  ...
  `<meta property="og:title" content="Pisitpong Chongpipattanakul - Resume" />`,
  ...
  `<meta name="twitter:title" content="Pisitpong Chongpipattanakul - Resume" />`,
